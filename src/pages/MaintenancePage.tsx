...
export default function MaintenancePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A5C38] to-[#00261a] flex items-center justify-center p-6">
      <div className="max-w-lg w-full text-center">
        ...
        <div className="w-20 h-20 rounded-full bg-white/10 flex items-center justify-center mx-auto mb-8">
          <Wrench size={36} className="text-[#3DB83A]" />
        </div>
        ...
        <div className="w-full max-w-xs mx-auto">
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <div className="h-full bg-[#3DB83A] rounded-full animate-pulse w-2/3" />
          </div>
