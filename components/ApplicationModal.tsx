...
const STEPS = [
  { id: 1, title: 'Lavoro', icon: Briefcase, color: 'from-purple-500 to-pink-500' },
  { id: 2, title: 'Presentati', icon: MessageSquare, color: 'from-teal-500 to-green-500' },
  { id: 3, title: 'Dati Personali', icon: User, color: 'from-blue-500 to-cyan-500' },
];

const MOTIVATIONAL_MESSAGES = [
  { step: 1, message: "Perfetto! Le agenzie apprezzano la trasparenza", emoji: "💼" },
  { step: 2, message: "Ottimo! Una breve presentazione fa la differenza", emoji: "✨" },
  { step: 3, message: "Ultimo passo! Inserisci i tuoi dati personali", emoji: "👋" },
];
